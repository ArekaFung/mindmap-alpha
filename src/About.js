        ...
        <div className='about-container'>
            <div className='intro-section'>
                <div className='intro-section-left'>
                    ...
                    <div className='contact-list'>
                        <a target='_blank' href="https://www.linkedin.com/in/areka-fung-78b0702b0/" ><img className='icon' src={require('./assets/linkedin.svg').default} /></a>
                        <a target='_blank' href="https://github.com/ArekaFung" ><img className='icon' src={require('./assets/github.svg').default} /></a>
                        <a target='_blank' href="https://www.instagram.com/areka.forsure" ><img className='icon' src={require('./assets/instagram.svg').default} /></a>
                    </div>
                    <div style={{ position: "relative" }}>
                        <div className='letgo-btn'>
                            <span className='text' onClick={() => navigate('/map')}>Let's Map!</span>
                        </div>
                        <img style={{ position: "absolute", bottom: "-40px", left: "165px" }} class="icon" src={clickmeIcon} />
                    </div>
                </div>
            ...
            <div className='skillset-container'>
                ...
                <div className='box-wrapper'>
                    ...
                    <div className='box'>
                        <img class="icon" src={pastexpIcon} />
                        <span className='header'>
                            Past Experience
                        </span>
                        <span className='description'>
